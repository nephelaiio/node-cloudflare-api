...
const packages = [
    { id: '0000000000000000000000000000000a', zone_id: zones[0].id, zone_name: zones[0].name },
    { id: '0000000000000000000000000000000b', zone_id: zones[1].id, zone_name: zones[1].name  },
    { id: '0000000000000000000000000000000c', zone_id: zones[0].id, zone_name: zones[0].name  },
    { id: '0000000000000000000000000000000d', zone_id: zones[0].id, zone_name: zones[0].name  },
    { id: '0000000000000000000000000000000e', zone_id: zones[1].id, zone_name: zones[1].name  },
    { id: '0000000000000000000000000000000f', zone_id: zones[1].id, zone_name: zones[1].name  }
]
...
const exec = mock(({path}) => {
    ...
    switch (path) {
        ...
        case `/zones/${zones[0].id}/firewall/waf/packages?per_page=${maxPageSize}`:
            return Promise.resolve({ result: packages.filter((x) => x.zone_id == zones[0].id) })
        case `/zones/${zones[1].id}/firewall/waf/packages?per_page=${maxPageSize}`:
            return Promise.resolve({ result: packages.filter((x) => x.zone_id == zones[1].id) })
        default:
